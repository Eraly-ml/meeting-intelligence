...
from .config import executable, local_file
...
class AudioProcessor:
    ...
    def transcribe(self, source, language):
        ...
        if enabled:
            ...
            command([sys.executable, "-m", "meetingbox_engine.diarize", "--audio", str(wav),
        ...
        return {"segments": parse_whisper(payload, duration, turns), "duration": duration,
